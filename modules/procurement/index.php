                                            ...
                                            <div class="po-card">
                                                <div class="d-flex justify-content-between align-items-start mb-2">
                                                    ...
                                                    <span class="status-badge bg-<?php 
                                                        echo $po['delivery_status'] == 'Completed' ? 'success' : 
                                                            ($po['delivery_status'] == 'Partial' ? 'warning' : 
                                                            ($po['delivery_status'] == 'Pending' ? 'info' : 'secondary')); 
                                                    ?> text-white">
                                ...
                                <table class="table table-hover" id="inventoryTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-<?php 
                                                    echo $trans['transaction_type'] == 'Purchase' ? 'success' : 
                                                        ($trans['transaction_type'] == 'Sale' ? 'primary' : 
                                                        ($trans['transaction_type'] == 'Adjustment' ? 'warning' : 'info')); 
                                                ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('select[name="po_id"]').change(function() {
                let poId = $(this).val();
                if (poId) {
                    $.get('ajax/get-po-items.php', {po_id: poId}, function(data) {
